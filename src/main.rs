...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let rest_api_address =
        std::env::var("REST_API_ADDRESS").unwrap_or_else(|_| "https://www.googleapis.com".to_string());
    ...
    let server_address =
        std::env::var("SERVER_ADDRESS").unwrap_or_else(|_| "https://youtube.googleapis.com".to_string());
    let server_url =
