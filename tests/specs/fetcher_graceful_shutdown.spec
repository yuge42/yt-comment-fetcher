# YouTube Comment Fetcher Graceful Shutdown Test

This specification tests the graceful shutdown behavior of the YouTube Comment Fetcher when receiving SIGINT or SIGTERM signals.
...
## Test fetcher handles SIGINT gracefully
...
## Test fetcher handles SIGTERM gracefully
